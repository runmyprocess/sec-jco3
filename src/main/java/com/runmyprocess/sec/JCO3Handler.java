...
public class JCO3Handler {
    ...
    public static void main(String [] args)throws IOException {
        ...
        // Logging instance
        final SECLogManager LOG = new SECLogManager(JCO3.class.getName());
        try{
            GenericHandler genericHandler = new GenericHandler();//Creates a new instance of generic handler
            LOG.log( "Starting JCO3 Adapter...",Level.INFO);
            ...
            LOG.log( "JCO3 Adapter Started",Level.INFO);
        }catch( Exception e ){
